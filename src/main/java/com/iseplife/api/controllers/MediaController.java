...
public class MediaController {
  ...
  @PostMapping("/lambda/set-state/{status}")
  public void updateImageProcessingStatus(@PathVariable MediaStatus status, @RequestParam String name, @RequestParam() String secret_token){
