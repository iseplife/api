...
public class WeiMapController {
  ...
  static {
    ...
    map.put(216, new Double[]{45.108298136181254,1.963761872214032});
    map.put(217, new Double[]{45.10826175657635,1.963506706747431});
    map.put(218, new Double[]{45.108298136181254,1.9633195854052572});
    map.put(219, new Double[]{45.108334515786154,1.9631154530319768});
    map.put(222, new Double[]{45.10858917302048,1.962264901476641});
    map.put(223, new Double[]{45.108686185300236,1.9620607691033602});
    map.put(224, new Double[]{45.1087346914401,1.9619076698233997});
    map.put(226, new Double[]{45.108940842534565,1.9616695153879058});
    map.put(227, new Double[]{45.10888020985972,1.9618736477611864});
    map.put(228, new Double[]{45.108819577184875,1.9620947911655737});
    map.put(230, new Double[]{45.10858917302048,1.962928331689803});
    map.put(231, new Double[]{45.108540666880614,1.9631154530319768});
    map.put(232, new Double[]{45.108528540345645,1.9633195854052572});
    map.put(233, new Double[]{45.10850428727571,1.9635407288096445});
    map.put(234, new Double[]{45.10850428727571,1.9637958942762455});
    map.put(235, new Double[]{45.10849216074074,1.9640850818050597});
    map.put(261, new Double[]{45.1084679076708,1.9659392841956915});
    map.put(262, new Double[]{45.108516413810676,1.9656330856357707});
    map.put(263, new Double[]{45.108528540345645,1.965394931200277});
    map.put(264, new Double[]{45.108540666880614,1.9651737877958892});
    map.put(265, new Double[]{45.10855279341558,1.9650887326403557});
    map.put(266, new Double[]{45.108540666880614,1.9648675892359686});
    map.put(267, new Double[]{45.10860129955545,1.964595412738261});
    map.put(268, new Double[]{45.10862555262539,1.9642551921161266});
    map.put(269, new Double[]{45.1086619322303,1.9639660045873126});
    map.put(270, new Double[]{45.10867405876527,1.9635917619029648});
    map.put(271, new Double[]{45.10879532411494,1.96309844200087});
    map.put(273, new Double[]{45.10884383025481,1.9626731662232022});
    map.put(274, new Double[]{45.10891658946463,1.9624860448810284});
    map.put(275, new Double[]{45.108940842534565,1.9622989235388544});
    map.put(276, new Double[]{45.109013601744365,1.9621118021966806});
    map.put(277, new Double[]{45.10909848748914,1.9618906587922933});
  }
